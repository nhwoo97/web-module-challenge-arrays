...
console.log('Task 5...',removeFlavorByName(originalFlavors,'Vanilla').length);
...
function copy(newArray,arr){
    newArray = arr;
    return newArray;

}
console.log('Task 6...',copy('copycat', originalFlavors));
...
function getAverageWordLength(arr){
    let numerator=0;
    for (let i=0; i<arr.length; i++){
        numerator= numerator+ arr[i].split(' ').length;
    }
    let wordLength = numerator/arr.length;
